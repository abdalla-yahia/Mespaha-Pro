...
// let script                 = document.getElementById('javascript-file'              );


    // localStorage.getItem('script-src')?
    // script.src = localStorage.getItem('script-src'): script.src = './js/app.js';
...
setTimeout(()=>{
  ...
  btn_loop.style.backgroundColor = 'red';
